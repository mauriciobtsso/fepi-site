...
from core.models import ConfiguracaoHome, ConfiguracaoYouTube, PostInstagram, Coluna
...
class PerfilForm(forms.ModelForm):
    class Meta:
        model = Perfil
        exclude = ['user'] # O administrador pode editar tudo, menos trocar o login associado
        widgets = {
