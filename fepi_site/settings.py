...
ARQUIVO CORRIGIDO: Veja as linhas 263-282 para a configuração corrigida do Editor.js
"""
...
# ============================================================================
# ✅ CONFIGURAÇÃO CORRIGIDA DO EDITOR.JS (LINHAS 263-282)
# ============================================================================
# PROBLEMA ORIGINAL: "tunes" estava duplicado e mal posicionado
# SOLUÇÃO: Mover "tunes" para dentro da configuração de cada ferramenta
# ============================================================================
...
EDITORJS_FIELDS_CONFIG = {
    "tools": {
        "Header": {
            "class": "Header",
            "config": {"levels": [2, 3, 4]},
            "tunes": ["delete"]  # ✅ CORRIGIDO: tunes agora está aqui
        },
        "List": {
            "class": "List",
        ...
        "Image": {
            ...
            "tunes": ["delete"]  # ✅ CORRIGIDO: tunes agora está aqui (PRINCIPAL FIX)
        }
    }
    # ✅ REMOVIDO: "tunes": ["delete"] que estava duplicado aqui
}
