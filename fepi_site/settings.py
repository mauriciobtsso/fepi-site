...
INSTALLED_APPS = [
    ...
    # CLOUDINARY (Antes de staticfiles)
    'cloudinary_storage',
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware', # WhiteNoise para CSS/JS
...
# Geridos pelo WhiteNoise no Railway
STATIC_URL = '/static/'
STATIC_ROOT = BASE_DIR / 'staticfiles' 
STATICFILES_DIRS = [BASE_DIR / 'static']

# --- ARQUIVOS DE MÍDIA (FOTOS, UPLOADS) ---
# Geridos pelo Cloudinary (Armazenamento Externo)
MEDIA_URL = '/media/' 
MEDIA_ROOT = BASE_DIR / 'media' 

# Credenciais do Cloudinary (Sem proxy!)
CLOUDINARY_STORAGE = {
...
# Configuração de Armazenamento (Django 5+)
STORAGES = {
    # Media: Usa Cloudinary
    "default": {
        "BACKEND": "cloudinary_storage.storage.MediaCloudinaryStorage",
    },
    # Static: Usa WhiteNoise (Permissivo)
    "staticfiles": {
